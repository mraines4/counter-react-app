...
// import ConfigCount from './ConfigCount';
...
class App extends React.Component {
  ...
  bounceIt = () => {
    ...
    this.setState({
      bouncers: this.state.bouncers.concat(anim)
    })
  }
    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <BouncyCount />
          <button onClick={this.bounceIt}>   CLICK IT   </button>
          {this.state.bouncers.map((count) => {
            return <BouncyCount />
          })}
        </header>
      </div>
